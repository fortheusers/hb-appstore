...
case "${PLATFORM}" in
  ...
  wiiu)   # uses wut
      ...
      sudo dkp-pacman --noconfirm -S wut-linux wiiu-sdl2 devkitPPC wiiu-libromfs wiiu-sdl2_gfx wiiu-sdl2_image wiiu-sdl2_ttf wiiu-sdl2_mixer wiiu-zlib wiiu-bzip2 wiiu-freetype wiiu-mpg123 wiiu-libpng wiiu-curl-headers wiiu-pkg-config
    ;;
esac
